  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate Your Dining Experience with restaurant50: Streamlining Operations and Maximizing Efficiency for a Seamless Restaurant Management System"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Elevate Your Dining Experience with restaurant50: Streamlining Operations and Maximizing Efficiency for a Seamless Restaurant Management System`}
            </Text>
